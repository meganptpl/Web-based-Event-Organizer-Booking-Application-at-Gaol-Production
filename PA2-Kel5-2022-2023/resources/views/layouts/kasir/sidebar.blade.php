<div class="sidebar-wrapper">
    <div>
        <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light"
                    src="assets/admin/assets/images/logo/small-logo.png" alt=""><img class="img-fluid for-dark"
                    src="assets/admin/assets/images/logo/small-white-logo.png" alt=""></a>
            <div class="back-btn"><i class="fa fa-angle-left"></i></div>
        </div>
        <div class="logo-icon-wrapper"><a href="index.html"><img class="img-fluid"
                    src="assets/admin/assets/images/logo-icon.png" alt=""></a></div>
            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title" href="{{ url('/home-kasir') }}">
