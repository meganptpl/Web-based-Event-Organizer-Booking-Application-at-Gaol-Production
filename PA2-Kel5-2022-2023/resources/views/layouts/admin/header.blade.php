<div class="page-header">
    <div class="header-wrapper row m-0"> 
      <div class="header-logo-wrapper col-auto p-0">
        <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="assets/admin/assets/images/logo/logo.png" alt=""></a></div>
        ...
        <ul class="nav-menus">
          <li class="profile-nav onhover-dropdown pe-0 py-0 me-0">
            ...
            <ul class="profile-dropdown onhover-show-div">
              <li>
                <form action="{{ url('/do_logout') }}" method="post">
                  @csrf
                  <button type="submit" class="btn"><i data-feather="log-out"> </i>Logout</button>
               </form>
              </li>
            </ul>
          </li>
