<x-app-layout title="Edit Paket Dekorasi">
    <!-- Page Sidebar Ends-->
    <div class="page-body">
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-sm-6">
                        <h3>
                            Edit Paket Dekorasi</h3>
                    </div>
                    <div class="col-12 col-sm-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html"> <i data-feather="home"></i></a></li>
                            <li class="breadcrumb-item">Paket Dekorasi</li>
                            <li class="breadcrumb-item active">Edit Paket Dekorasi </li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form class="form theme-form projectcreate"
                                action="{{ route('admin.paketdekorasi.update', $paketdekorasi->id) }}" method="POST"
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="exampleFormControlTextarea4" rows="3"
                                                name="deskripsi">{{ $paketdekorasi->deskripsi }}</textarea>
                                            @error('deskripsi')
                                                <span class="alert-danger">
                                                    {{ $message }}
                                                </span>
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input type="file"
                                                ...
                                                name="gambar" value="{{ $paketdekorasi->gambar }}">
                                            @error('gambar')
                                                <span class="alert-danger">
                                                    {{ $message }}
                                                </span>
                                    ...
                                    <div class="col">
                                        <div class="text-end">
                                            ...
                                            <a class="btn btn-danger"
                                                href="{{ route('admin.paketdekorasi.index') }}">Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
