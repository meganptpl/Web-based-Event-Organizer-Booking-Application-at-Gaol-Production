<x-app-layout title="Tambah Paket Acara">
    <!-- Page Sidebar Ends-->
    <div class="page-body">
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-sm-6">
                        <h3>
                            Tambah Paket Acara</h3>
                    </div>
                    <div class="col-12 col-sm-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html"> <i data-feather="home"></i></a></li>
                            <li class="breadcrumb-item">Paket Acara</li>
                            <li class="breadcrumb-item active">Tambah Paket Acara </li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form theme-form projectcreate" action="{{ route('admin.paketacara.store') }}"
