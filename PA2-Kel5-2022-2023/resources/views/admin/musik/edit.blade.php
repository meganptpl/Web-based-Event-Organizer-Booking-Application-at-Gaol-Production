                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Edit Paket Musik </li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form class="form theme-form projectcreate"
                                action="{{ route('admin.paketmusik.update', $paketmusik->id) }}" method="POST"
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="exampleFormControlTextarea4" rows="3"
                                                name="deskripsi">{{ $paketmusik->deskripsi }}</textarea>
                                            @error('deskripsi')
                                                <span class="alert-danger">
                                                    {{ $message }}
                                                </span>
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input type="file"
                                                ...
                                                name="gambar" value="{{ $paketmusik->gambar }}">
                                            @error('gambar')
                                                <span class="alert-danger">
                                                    {{ $message }}
                                                </span>
